...
type TorchRawTensor(tt: torch.Tensor, shape: Shape, dtype: Dtype, device: Device) =
    ...
    member private _.ToRawDataViaDirectAccess< 'T when 'T: unmanaged and 'T: struct and 'T :> ValueType and 'T : (new : unit -> 'T) >() : 'T[] =
    ...
    override t.SplitT(sizes, dim) =
        ...
        let results = tt.split(int64s sizes, dim=int64 dim)
    ...
    new (info: System.Runtime.Serialization.SerializationInfo, _context: System.Runtime.Serialization.StreamingContext) =
        ...
        let tt =
            ...
            | Dtype.Bool -> 
                ...
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Bool))
            | Dtype.Byte -> 
                let data = info.GetValue("data", typeof<byte[]>)  :?> byte[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Byte))
            | Dtype.Int8 -> 
                let data = info.GetValue("data", typeof<sbyte[]>)  :?> sbyte[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Int8))
            | Dtype.Int16 -> 
                let data = info.GetValue("data", typeof<int16[]>)  :?> int16[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Int16))
            | Dtype.Int32 -> 
                let data = info.GetValue("data", typeof<int32[]>)  :?> int32[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Int32))
            | Dtype.Int64 -> 
                let data = info.GetValue("data", typeof<int64[]>)  :?> int64[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Int64))
            | Dtype.Float32 -> 
                let data = info.GetValue("data", typeof<float32[]>)  :?> float32[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Float32))
            | Dtype.Float64 -> 
                let data = info.GetValue("data", typeof<double[]>)  :?> double[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Float64))
            | Dtype.Float16 -> 
                let data = info.GetValue("data", typeof<float32[]>)  :?> float32[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.Float16))
            | Dtype.BFloat16 -> 
                let data = info.GetValue("data", typeof<float32[]>)  :?> float32[]
                torch.tensor(data, ReadOnlySpan<int64>(toTorchShape shape), dtype=Nullable(toTorchType Dtype.BFloat16))
...
type TorchFloat32TensorOps() = 
    ...
    inherit TorchTensorOps<single, single>(Dtype.Float32, id, 
        ...
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Float32))), 
        0.0f, 1.0f, 
...
type TorchFloat64TensorOps() =   
    inherit TorchTensorOps<double, double>(Dtype.Float64, id, 
        ...
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Float64))), 
        0.0, 1.0, 
...
type TorchInt8TensorOps() = 
    ...
    inherit TorchTensorOps<sbyte, sbyte>(Dtype.Int8, sbyte,
        (fun v -> torch.tensor(v)),
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Int8))), 
        0y, 1y,
...
type TorchInt16TensorOps() = 
    inherit TorchTensorOps<int16, int16>(Dtype.Int16, int16, 
        (fun v -> torch.tensor(v)), 
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Int16))), 
        0s, 1s,
...
type TorchInt32TensorOps() = 
    inherit TorchTensorOps<int32, int32>(Dtype.Int32, int32, 
        (fun v -> torch.tensor(v)), 
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Int32))), 
        0, 1,
...
type TorchInt64TensorOps() = 
    ...
    inherit TorchTensorOps<int64, int64>(Dtype.Int64, int64, 
        (fun v -> torch.tensor(v)), 
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Int64))), 
        0L, 1L,
...
type TorchBoolTensorOps() = 
    ...
    inherit TorchTensorOps<bool, bool>(Dtype.Bool, id, 
        ...
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Bool))), 
        false, true,
...
type TorchByteTensorOps() = 
    ...
    inherit TorchTensorOps<byte, byte>(Dtype.Byte, id, 
        (fun v -> torch.tensor(v)), 
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Byte))), 
        0uy, 1uy,
...
type TorchFloat16TensorOps() = 
    ...
    inherit TorchTensorOps<single, single>(Dtype.Float16, id, 
        ...
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.Float16))), 
        0.0f, 1.0f, 
...
type TorchBFloat16TensorOps() = 
    ...
    inherit TorchTensorOps<single, single>(Dtype.BFloat16, id, 
        ...
        (fun (data, shape) -> torch.tensor(data, ReadOnlySpan<int64>(shape), dtype=Nullable(toTorchType Dtype.BFloat16))), 
        0.0f, 1.0f, 
